...
export const GuideDetailPage: React.FC = () => {
  ...
  if (unlocked) {
    return (
      <div className="pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 space-y-8">
    ...
    <div className="pt-28 pb-20 max-w-5xl mx-auto px-4 sm:px-6">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="max-h-[340px] aspect-[16/9] rounded-xs overflow-hidden shadow-lg bg-[#FAF8F5]">
