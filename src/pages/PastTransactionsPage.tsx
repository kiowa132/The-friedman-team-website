            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                {MENTOR_TRANSACTIONS.map((t, i) => (
                  <div key={i}>
                    <div className="relative aspect-[4/3] overflow-hidden bg-[#0D2226]/60 flex items-center justify-center border border-[#C9A96A]/20">
                      {t.image ? (
                        <img src={t.image} alt={t.address} className="w-full h-full object-cover" />
                      ) : (
                    ...
                    <div className="pt-4">
                      <div className="font-serif text-xl font-bold text-[#FAF8F5] uppercase tracking-wide">{t.address}</div>
                      <div className="font-semibold text-[#C9A96A] mt-1">{t.priceDisplay}</div>
                      <div className="text-xs text-[#A8B2A1] mt-2 uppercase tracking-wide">{t.address}, {t.cityStateZip}</div>
                      <div className="flex items-center gap-3 text-xs text-[#A8B2A1] mt-2 font-semibold">
                      ...
                      <div className="text-[10px] uppercase tracking-widest text-[#C9A96A]/70 font-bold mt-2">
                        Sold by {MENTOR_NAME}
                      </div>
                    </div>
                  </div>
