...
export const GuidesListPage: React.FC = () => {
  ...
  return (
    <div className="pt-28 pb-24" style={{ background: 'radial-gradient(ellipse at top, #16262a 0%, #0D2226 60%)' }}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-20">
          <span className="text-xs font-bold uppercase tracking-[0.3em] text-[#C9A96A]">
            The Friedman Team Library
          </span>
          <h1 className="font-serif text-5xl sm:text-6xl font-bold text-white mt-3">
            Guides
          </h1>
