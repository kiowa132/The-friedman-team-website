    ...
    <div className="pt-28 pb-20 max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5">
          <div id="schedule-showing" className="lg:sticky lg:top-24 bg-[#0D2226] text-[#FAF8F5] p-6 rounded-xs border border-[#C9A96A]/40">
            ...
            <div className="pt-6 mt-6 border-t border-[#FAF8F5]/10 flex items-center gap-3">
              <div className="w-12 h-12 rounded-full border border-[#C9A96A] overflow-hidden bg-[#0F5C63] shrink-0">
                <img src="/images/kyle-portrait.jpg" alt="Kyle Friedman" className="w-full h-full object-cover object-top" />
              </div>
      ...
      {/* Meet Your Agent - full-width card in the same spirit as the
          reference: large photo, name, title, real contact details, and
          the social links Kyle actually has (no fabricated ones). This is
          the honest place for this treatment, since Kyle is the real
          agent on his own listings. */}
      <div className="mt-16 bg-[#0D2226] overflow-hidden grid grid-cols-1 sm:grid-cols-[320px_1fr]">
        ...
        <div className="p-8 sm:p-10 text-[#FAF8F5]">
          <span className="text-[11px] uppercase tracking-widest text-[#C9A96A] font-bold">Meet Your Agent</span>
