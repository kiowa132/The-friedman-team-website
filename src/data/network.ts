...
export const NETWORK_MEMBERS: NetworkMember[] = [
  ...
  },
  {
    ...
    slug: 'anthony-poulin',
    name: 'Anthony Poulin',
    headshot: '/images/network/anthony-poulin.jpg',
    title: 'Producing LOA',
    company: 'Movement Mortgage',
    industry: 'Mortgage Lending',
    county: 'Anne Arundel County',
    markets: ['Annapolis area', 'Anne Arundel County'],
    bio: 'Anthony Poulin is a Producing LOA with Movement Mortgage, based in Annapolis, Maryland. Movement Mortgage is an Impact Lender, guaranteeing that at least 10% of profits go toward lifting up communities - Movement gives nearly 50%.',
    certifications: ['NMLS #2690068', 'State Licenses: CO-100546000, MD-2690068, PA-119038, VA-MLO-73975VA'],
    services: ['Home purchase financing', 'Refinancing', 'Affordability & mortgage guidance'],
    lookingToMeet: [`${PLACEHOLDER_PREFIX} not yet confirmed`],
    canHelpWith: ['Mortgage financing for home purchases', 'Refinancing', 'Helping buyers understand what they can afford'],
    website: 'https://movement.com/lo/anthony-poulin',
    linkedin: undefined,
    phone: '(571) 474-4794',
